...
```bash
git clone https://github.com/tetrashop/Translator.git
cd Translator
# دستورات نصب
```
...
- **URL:** [  🚀 دیپلوی Translator روی Vercel...
    ❌ دیپلوی ناموفق!
...
Learn More: https://vercel.com/docs/projects/overview#project-name](  🚀 دیپلوی Translator روی Vercel...
    ❌ دیپلوی ناموفق!
error: "/data/data/com.termux/files/usr/lib/node_modules/vercel/dist/get-latest-worker.cjs" has bad ELF magic: 2f2a2a0a
Vercel CLI 58.5.1 (Node.js 26.4.0)
...
<!-- Trigger deploy: Mon Aug 17 01:48:08 +0330 2026 -->

## 🌐 دیپلوی

- **URL:** [https://Translator.vercel.app](https://Translator.vercel.app)
- **وضعیت:** ✅ فعال
